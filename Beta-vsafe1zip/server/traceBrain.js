...
const THERAPY_PATTERNS = [
  ...
  // === GENERIC ACTIVITY SUGGESTIONS (REWRITE IN TRACE VOICE, NOT DELETE) ===
  { pattern: /Let me suggest an activity[^.!?]*[.!?]?/gi, replacement: "hey — I've got something that might help." },
  { pattern: /How about a gentle breathing exercise[^.!?]*[.!?]?/gi, replacement: "want to try something quick?" },
  { pattern: /How about a calming soundscape[^.!?]*[.!?]?/gi, replacement: "want me to put something on?" },
  { pattern: /How about (a |some |trying )?(breathing|grounding|meditation|mindfulness|relaxation)[^.!?]*[.!?]?/gi, replacement: "I've got something that might actually help right now. want to try it?" },
  { pattern: /Would you like to try (a |some )?(breathing|grounding|meditation|mindfulness)[^.!?]*[.!?]?/gi, replacement: "want to try something quick?" },
  { pattern: /Maybe (a |some )?(breathing exercise|grounding exercise|mindfulness exercise|calming activity)[^.!?]*[.!?]?/gi, replacement: "there's a quick thing we could do if you want." },
  { pattern: /I can (suggest|recommend|offer) (a |an |some )?(activity|exercise|breathing|grounding|soundscape)[^.!?]*[.!?]?/gi, replacement: "hey — I've got something that might help." },
  { pattern: /Would water,? a few breaths,? or a short walk support you( right now)?[.?]?/gi, replacement: "want to try something quick?" },
  { pattern: /Would water,? breaths,? or a walk support you( right now)?[.?]?/gi, replacement: "want to try something quick?" },
  { pattern: /Would you like (water|a few breaths|a short walk|some rest)[^.?]*[.?]?/gi, replacement: "want to try something?" },
  { pattern: /Would (water|a few breaths|a short walk),? [^?]+support you[^?]*[.?]?/gi, replacement: "want to try something?" },
