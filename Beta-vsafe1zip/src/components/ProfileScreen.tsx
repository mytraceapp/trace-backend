                ...
                <motion.div
                  ...
                  style={{
                    ...
                    background: `conic-gradient(
                      ...
                      rgba(180, 150, 110, 0.18) 45deg,
                      transparent 90deg,
                      rgba(190, 160, 120, 0.29) 135deg,
                      rgba(175, 145, 105, 0.16) 180deg,
                      transparent 225deg,
                      rgba(195, 165, 125, 0.26) 270deg,
                      rgba(180, 150, 110, 0.16) 315deg,
                      rgba(200, 170, 130, 0.36) 360deg
                    )`,
                    filter: 'blur(3px)',
                  }}
                  animate={{
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    background: `conic-gradient(
                      from 90deg at 50% 50%,
                      transparent 0deg,
                      rgba(205, 175, 135, 0.29) 60deg,
                      transparent 120deg,
                      rgba(195, 165, 125, 0.26) 180deg,
                      transparent 240deg,
                      rgba(185, 155, 115, 0.21) 300deg,
                      transparent 360deg
                    )`,
                    filter: 'blur(4px)',
                  }}
