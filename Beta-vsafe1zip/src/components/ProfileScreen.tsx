              ...
              <>
                ...
                <motion.div
                  ...
                  style={{
                    width: '130px',
                    height: '130px',
                    background: 'radial-gradient(circle, rgba(210, 180, 140, 0.41) 0%, rgba(190, 160, 120, 0.27) 40%, rgba(170, 140, 100, 0.12) 60%, transparent 80%)',
                    filter: 'blur(6px)',
                  }}
                  animate={{
                    opacity: [0.33, 0.48, 0.33],
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    background: `conic-gradient(
                      from 0deg at 50% 50%,
                      rgba(200, 170, 130, 0.38) 0deg,
                      rgba(180, 150, 110, 0.19) 45deg,
                      transparent 90deg,
                      rgba(190, 160, 120, 0.31) 135deg,
                      rgba(175, 145, 105, 0.17) 180deg,
                      transparent 225deg,
                      rgba(195, 165, 125, 0.27) 270deg,
                      rgba(180, 150, 110, 0.17) 315deg,
                      rgba(200, 170, 130, 0.38) 360deg
                    )`,
                    filter: 'blur(3px)',
                  }}
                  animate={{
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    background: `conic-gradient(
                      from 90deg at 50% 50%,
                      transparent 0deg,
                      rgba(205, 175, 135, 0.31) 60deg,
                      transparent 120deg,
                      rgba(195, 165, 125, 0.27) 180deg,
                      transparent 240deg,
                      rgba(185, 155, 115, 0.22) 300deg,
                      transparent 360deg
                    )`,
                    filter: 'blur(4px)',
                  }}
                ...
                <motion.div
                  ...
                  style={{
                    width: '85px',
                    height: '85px',
                    background: 'radial-gradient(circle, rgba(220, 190, 150, 0.41) 0%, rgba(200, 170, 130, 0.27) 50%, transparent 75%)',
                    filter: 'blur(2px)',
                  }}
                  animate={{
                    scale: [0.9, 1.1, 0.9],
