    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      ...
      <div className="fixed bottom-4 left-4 bg-white p-4 rounded-lg shadow-lg max-w-xs">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <button
            onClick={() => setCurrentScreen("accountsetup")}
            className="px-3 py-1 bg-blue-500 text-white rounded text-sm"
          >
            Setup
          </button>
          ...
          <button
            onClick={() => setCurrentScreen("activitieshub")}
            className="px-3 py-1 bg-blue-500 text-white rounded text-sm"
          >
            Activities
          </button>
          ...
          <button
            onClick={() => setCurrentScreen("walking")}
            className="px-3 py-1 bg-blue-500 text-white rounded text-sm"
          >
            Walking
          </button>
          <button
            onClick={() => setCurrentScreen("powernap")}
            className="px-3 py-1 bg-blue-500 text-white rounded text-sm"
          >
            Power Nap
          </button>
          ...
          <button
            onClick={() => setCurrentScreen("rainwindow")}
            className="px-3 py-1 bg-blue-500 text-white rounded text-sm"
          >
            Rain Window
          </button>
          <button
            onClick={() => setCurrentScreen("echo")}
            className="px-3 py-1 bg-blue-500 text-white rounded text-sm"
          >
            Echo
          </button>
          ...
          <button
            onClick={() => setCurrentScreen("fullpatterns")}
            className="px-3 py-1 bg-blue-500 text-white rounded text-sm"
          >
            Full Patterns
          </button>
          ...
          <button
            onClick={() => setCurrentScreen("inthisspace")}
            className="px-3 py-1 bg-blue-500 text-white rounded text-sm"
          >
            In This Space
          </button>
